...
void gameview::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->spawnPlatform(); break;
        case 3: _t->checkGameOver(); break;
        case 4: _t->removeOutOfScreenItems(); break;
        case 5: _t->magnetTick(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (gameview::*)()>(_a, &gameview::backToMenu, 0))
            return;
    }
}
